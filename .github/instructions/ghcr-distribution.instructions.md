...
- Keep `fork/main` authoritative for CubeCloud runtime changes. Choose the upstream sync method intentionally:
  - cherry-pick for selected upstream fixes without taking unrelated runtime or release changes
  - merge or rebase for a broader upstream refresh with full validation before republishing
