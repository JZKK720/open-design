...
export const en: Dict = {
  ...
  'settings.byokNoFileToolsNotice':
    'BYOK mode talks to the model directly and cannot read, write, or modify project files. The model can reply with text or HTML, but it cannot persist file changes. Use Local CLI mode (Claude Code, Codex, and similar) when you need file edits.',
  'settings.designSystemRenameFailed': 'Rename failed. Check the daemon and try again.',
  ...
  'handoff.menuTitle': 'Where should this open?',
  ...
  'routines.fieldPromptPlaceholder':
    'Pull yesterday’s GitHub + Linear activity and summarize what changed.',
  ...
  'chat.queuedHeader': 'Queued updates',
  'chat.queuedToSend': 'Queued to send',
  'chat.queuedMore': '{count} more queued updates',
  'chat.queuedFollowUpFallback': 'Follow-up update',
  'chat.queuedEdit': 'Edit',
  'chat.queuedSave': 'Save',
  'chat.queuedCancel': 'Cancel',
  'chat.queuedEditQueuedTaskAria': 'Edit queued update',
  'chat.inspect.noCommentTargets': 'No comment targets found in this artifact.',
  'chat.inspect.commentHint': 'Select an element in preview to add a comment target.',
  'chat.inspect.noEditableTargets': 'No editable targets found in this artifact.',
  'chat.inspect.editHint': 'Select an element in preview to open editable targets.',
  'chat.you': 'You',
  ...
  'manualEdit.noEditableLayers': 'No editable layers found for this artifact.',
